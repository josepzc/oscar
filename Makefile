...
build_beemarket:
	...
	./manage.py loaddata sampledata/fixtures/child_products.json
	./manage.py oscar_import_catalogue sampledata/fixtures/*.csv
	./manage.py oscar_import_catalogue_images sampledata/fixtures/images.tar.gz
	./manage.py oscar_populate_countries
	./manage.py loaddata sampledata/_fixtures/pages.json sampledata/_fixtures/auth.json sampledata/_fixtures/ranges.json sampledata/_fixtures/offers.json
	./manage.py loaddata sampledata/fixtures/orders.json
	./manage.py clear_index --noinput
	./manage.py update_index catalogue

beemarket: install build_beemarket
